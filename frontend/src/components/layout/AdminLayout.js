...
const AdminLayout = ({ children }) => {
  ...
  const notifications = [
    { id: 1, title: 'New user registered', message: 'John Doe joined the organization', time: '5 min ago', unread: true },
    { id: 2, title: 'Task completed', message: 'Sarah completed Task #123', time: '1 hour ago', unread: true },
    { id: 3, title: 'System update', message: 'NexusFlow updated to v2.1.0', time: '2 hours ago', unread: false },
  ];
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      {/* Mobile Sidebar */}
      <div className={`lg:hidden fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-2xl transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gray-50 border-t border-gray-200">
          <div className="flex items-center space-x-3 p-3 rounded-xl bg-white shadow-sm">
            ...
            <div className="flex-1 min-w-0">
              ...
              {/* Admin/Super Admin role display commented out */}
      ...
      <motion.div 
        ...
        className="flex-1 flex flex-col min-w-0 lg:ml-20">
        {/* Top navigation */}
              ...
              <div className="hidden md:block ml-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-12 pr-4 py-2 border border-gray-200 bg-gray-50 rounded-lg focus:ring-2 focus:ring-primary-500 focus:bg-white focus:border-primary-500 transition-all duration-200 w-80"
                  />
                </div>
              </div>
            </div>
